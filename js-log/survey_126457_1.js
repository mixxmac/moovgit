...
/******** BEGIN JQUERY ********/
//Fix any jquery namespace problems
//if (window.jQuery !== undefined) {
// window.jQueryDollar = (window.$ === window.jQuery);
// window.jQueryOrig = jQuery.noConflict(true);
//}
...
;/*
*   Based on this script by Nikolay Kuchumov
*	https://github.com/kuchumovn/jquery-full-house
*	This is a modified version to meet our needs.
*/
(function(c){var d={Interface:function(e){this.too_big=function(f){};this.fits=function(f){}},Binary:function(e){var h;var g;var f=e.Font_size_increment_step||10;this.too_big=function(i){g=i;if(h){if(h===i-1){return h}return this.retry(h+(i-h)/2)}else{if(i===1){return 1}return this.retry(i-f)}};this.fits=function(i){h=i;if(g){if(g===i+1){return i}return this.retry(i+(g-i)/2)}else{return this.retry(i+f)}return i}}};function b(f){if(f.css("fontSize")){var e=f.css("fontSize").match(/[\d]+px/);if(e.length){return parseInt(e[0])}}return 1}function a(f,t){var q=b(f);f.css("fontSize",0);var l=f.html();f.empty();var h=f.css("overflow");f.css("overflow","hidden");var s=c("<span/>").html(l).appendTo(f);var o=f[0].scrollHeight;var i=f[0].scrollWidth;r(q);var e=f[0].scrollHeight;var n=f[0].scrollWidth;var k=e/o;var p=n/i;if(e==o&&n==i){f.css("overflow",h);f.empty().html(l);return q}else{t.algorythm=t.algorythm||"Binary";var j=new d[t.algorythm](t);var g=m(j,q);f.css("overflow",h);f.empty().html(l);return g}function r(u){f.css({fontSize:u+"px"})}function m(w,v){var u=function(x){x=Math.ceil(x);if(x<1){x=1}r(x);var z=f[0].scrollHeight;var y=f[0].scrollWidth;var A=z/o;var B=y/i;if(A>1||B>1){return w.too_big(x)}else{return w.fits(x)}};w.retry=u;return u(v)}}c.fn.fill_with_text=function(e){e=e||{};return c(this).each(function(){var f=c(this);f.css({fontSize:a(f,e)+"px"})})}})(jQuery);		

//Conflict fixes
window.$jbrSurveyInvitation = jQuery.noConflict(true);
/******** END JQUERY ********/
...
(function ($) {
    ...
    bizrate = {
        ...
        brDialog: function ($) {
            ...
            methods = {
                init: function (options) {
                    ...
                    return this.each(function () {
                        var $this, brdWin, brdHead, brdTitle,
                            brdBody, brdClose, bodanchor,
                            container = (document.getElementById('dynamicBzSurveyContents')
                                && settings.inviteImageUrl === 'https://images.bizrate.com/eval/survey/invite_template/non-buyer/template_multi_no_logo.gif')
                                ? $(document.getElementById('dynamicBzSurveyContents'))
                                : $('<div>');
                        $this = $(this);
                        bod = $(document.body);
                        brdWin = container.addClass('brdialog-win').css({
                                zIndex: settings.z.toString(10),width: settings.width.toString(10) + 'px',position: 'absolute',left: settings.x.toString(10) + 'px',top: settings.y.toString(10) + 'px',border: '1px solid #ccc',
                        ...
                        brdHead =
                            $('<div>').addClass('brdialog-head').css({
                                backgroundColor: '#000080',height: '26px',cursor: 'default',lineHeight: '26px',color: '#FFF',fontSize: '12px',paddingLeft: '10px',paddingRight: '10px',fontFamily: 'Arial, Helvetica, sans-serif',
                                boxSizing: 'border-box',
                                MozBoxSizing: 'border-box',
                                MsBoxSizing: 'border-box',
                                WebkitBoxSizing: 'border-box'
                        ...
                        brdTitle =
                            $('<div>').addClass('brdialog-title')
                                      .text(settings.titleText).css({
                                whiteSpace:'nowrap', width: '180px', float: 'left',height: '100%',fontWeight: 'bold',fontFamily: 'Arial, Helvetica, sans-serif',fontSize: '12px',color: '#FFF',lineHeight: '26px',textAlign:'left',
                                boxSizing: 'border-box',
                                MozBoxSizing: 'border-box',
                                MsBoxSizing: 'border-box',
                                WebkitBoxSizing: 'border-box'
                        ...
                        brdClose =
                            $('<div>').addClass('brdialog-close')
                                      .text(settings.closeText).css({
                                cursor: 'pointer',float: 'right',height: '100%',fontSize: '9px',color: '#FFF',fontFamily: 'Arial, Helvetica, sans-serif',textDecoration: 'underline',lineHeight: '26px',
                                boxSizing: 'border-box',
                                MozBoxSizing: 'border-box',
                                MsBoxSizing: 'border-box',
                                WebkitBoxSizing: 'border-box'
                            });
                        brdClose.click(function () {
                            bizrate.logInvite(settings.pitchType, 1000100);
                            $this.brDialog('destroy');
                            return false;
                        });
                        brdBody =
                            $('<div>').addClass('brdialog-body').css({
                                backgroundColor: '#FFF',cursor: 'pointer, height:270px',
                                boxSizing: 'border-box',
                                MozBoxSizing: 'border-box',
                                MsBoxSizing: 'border-box',
                                WebkitBoxSizing: 'border-box'
                        ...
                        brdHead.append(brdTitle).append(brdClose);
                        brdBody.append($this);
                        brdWin.append(brdHead).append(brdBody);
                        brdWin.draggable({
                            handle: brdHead,
                            containment: 'window',
                            cursor: 'move'
                        });
                        $this.data('brd', brdWin);
                        if (settings.inviteImageUrl === 'https://images.bizrate.com/eval/survey/invite_template/non-buyer/template_multi_no_logo.gif') {
                            brdWin.css('display','block');
                        } else if (settings.inviteImageUrl === 'https://images.bizrate.com/eval/survey/invite_template/non-buyer/template_multi.gif') {
                            ...
                            .attr('href','//www.bizrate.com/?rf=sur')
                            .attr('target','_blank')
                            .attr('id','clickOut')
                            .html('Bizrate');

                            brdWin.append(anchor);
                            bod.append(brdWin);
                        } else {
                            bod.append(brdWin);
                        }
            ...
            $.fn.brDialog = function (method) {
                ...
                if (methods[method]) {
                    ...
                    $.error('Method ' +  method +
                            ' does not exist on jQuery.brDialog');
                    return this;
                }
            };
            return true;
        ...
        setParams: function () {
	    	var safeMerchantName = this.escapeString("GNC");
            ...
            this.dhtml = 1;
            this.frequency = (typeof(bizrate.params.br_frequency) != 'undefined' && !isNaN(bizrate.params.br_frequency)) ? bizrate.params.br_frequency : 30;
            this.percentage = (typeof(bizrate.params.br_percentage) != 'undefined' && !isNaN(bizrate.params.br_percentage) && (bizrate.params.br_percentage <= 100) && (bizrate.params.br_percentage >= 0)) ? bizrate.params.br_percentage : 100;
        ...
        getModalCoords: function (w, h, isPopup) {
            ...
            if (bizrate.params.modalX !== null &&
                ...
                o.x = (Math.floor(win.width() / 2) - Math.floor(w / 2));
            }
            if (bizrate.params.modalY !== null &&
                ...
                o.y = (Math.floor(win.height() / 2) - Math.floor(h / 2));
            }
            return o;
        },
        ...
        displayInviteModal: function () {
            ...
            if(document.getElementById('dynamicBzSurveyContents')
                    && bizrate.tplVars.inviteImageUrl === 'https://images.bizrate.com/eval/survey/invite_template/non-buyer/template_multi.gif') {
                this.inviteImageUrl = 'https://images.bizrate.com/eval/survey/invite_template/non-buyer/template_multi_no_logo.gif';
            } else {
                this.inviteImageUrl = bizrate.tplVars.inviteImageUrl;
            }

            d = $('<div>').attr('class', 'noprint').css({
                width: imgWidth,
                //height: imgHeight,
                backgroundColor: '#FFF',
                cursor: 'pointer',
            ...
            imt = $('<img />').attr('src',
            bizrate.tplVars.transparentImageUrl).css({
                position: 'absolute',
                top: '0px',
                left: '0px',
                cursor: 'pointer',
            ...
            im = $('<img />').attr('src', this.inviteImageUrl)
                .attr('alt', bizrate.tplVars.altImageText).css({
                boxSizing: 'border-box',
                MozBoxSizing: 'border-box',
                MsBoxSizing: 'border-box',
                WebkitBoxSizing: 'border-box',
                ...
                display: 'block',
                position: 'absolute',
                width: 'bizrate.tplVars.inviteWidth + px',
                height: 'bizrate.tplVars.inviteHeight + px'

            });
            imap = $('<img />').attr('usemap', "#br_invite_map").attr('src',
            bizrate.tplVars.transparentImageUrl).css({
                position: 'absolute',
                top: '0px',
                left: '0px',
            ...
            inviteMap = $('<map>').attr('name', 'br_invite_map');


            if (logoPath) {
                merchantLogo = $('<img />').attr('src', bizrate.tplVars.merchantLogoUrl)
                    .css(this.cssDefs({top:'15px', left:'10px', position:'absolute', border:'0px none', display:'inline'})).error(function () {$(this).hide();});
            }
            merchantWords = $('<div>').css(this.cssDefs({
                

            }));
            merchantWords2 = $('<div>').css(this.cssDefs({
                
            }));


            buttonImage = $('<img />').attr('src', bizrate.tplVars.buttonImageUrl)
                .css(this.cssDefs({
            ...
            anc.append(imt);
            anc.append(im);
            dimg.append(merchantWords);
            dimg.append(merchantWords2);
            if (logoPath) {
                dimg.append(merchantLogo);
            }
            ...
            if(u.indexOf('deviceType=ANDROID') > -1) {
                area1 = $('<area>').attr('coords', '0,0,' + '' + imgWidthNoPx + '' + ',' + '' + this.closeY + '').attr('shape', "rect").attr('href', u).attr('target','_blank');
            }

            else {
                area1 = $('<area>').attr('coords', '0,0,' + '' + imgWidthNoPx + '' + ',' + '' + this.closeY + '').attr('shape', "rect");
            }

            area2 = $('<area>').attr('coords', '0,' + '' + this.closeY + '' + ',' + '' + imgWidthNoPx + '' + ',' + '' + imgHeightNoPx + '').attr('shape', "rect");
            inviteMap.append(area1);
            inviteMap.append(area2);
            anc.append(inviteMap);
            ...
            $('.brdialog-title').fill_with_text();
            merchantWords.fill_with_text();
    ...
    **/
    ...
    if($.support.boxModel) {
        if(!$.browser.msie || ($.browser.msie && parseInt($.browser.version, 10) > 7 && document.documentMode && document.documentMode > 7)) {
            bizrate.init();
        }
    }
    return true;
